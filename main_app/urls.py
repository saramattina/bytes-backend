...
from .views import (
    ...
    GroceryListView, AddRecipeToGroceryListView, UpdateGroceryListItemView, 
    ClearCheckedItemsView, AddGroceryListItemView,  # Add this import
    UpdateUsernameView, UpdatePasswordView, DeleteAccountView
)
...
urlpatterns = [
    ...
    path("grocery-list/add-item/", AddGroceryListItemView.as_view(), name="add-grocery-item"),
